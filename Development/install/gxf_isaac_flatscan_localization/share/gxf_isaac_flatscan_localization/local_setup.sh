...
: ${AMENT_CURRENT_PREFIX:="/workspaces/isaac_ros-dev/install/gxf_isaac_flatscan_localization"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gxf_isaac_flatscan_localization/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gxf_isaac_flatscan_localization/environment/library_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gxf_isaac_flatscan_localization/environment/path.sh"

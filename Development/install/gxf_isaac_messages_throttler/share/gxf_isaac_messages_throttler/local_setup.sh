...
: ${AMENT_CURRENT_PREFIX:="/workspaces/isaac_ros-dev/install/gxf_isaac_messages_throttler"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gxf_isaac_messages_throttler/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gxf_isaac_messages_throttler/environment/path.sh"

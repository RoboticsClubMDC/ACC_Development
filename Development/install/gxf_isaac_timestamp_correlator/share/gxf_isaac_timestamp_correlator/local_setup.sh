...
: ${AMENT_CURRENT_PREFIX:="/workspaces/isaac_ros-dev/install/gxf_isaac_timestamp_correlator"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gxf_isaac_timestamp_correlator/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gxf_isaac_timestamp_correlator/environment/library_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gxf_isaac_timestamp_correlator/environment/path.sh"

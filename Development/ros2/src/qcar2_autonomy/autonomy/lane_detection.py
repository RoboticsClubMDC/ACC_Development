...
class LaneDetectionNode(Node):
    def __init__(self):
        ...
        # ROS params
        self.declare_parameter("image_topic", "/camera/csi_image")   # <- changed to CSI
        ...
        # Subscriber — BEST_EFFORT to match CSI node
    ...
    def image_cb(self, msg: Image):
        ...
        # ---- Lane selection with hysteresis ----
        ...
        # Publish selected lane mask (mono8, 0 or 255)
        lane_sel_msg = self.bridge.cv2_to_imgmsg(
            lane_sel.astype(np.uint8) * 255, encoding="mono8")

# Keyboard-drive cartographer stack for physical QCar2.
# Uses qcar2_keyboard_drive_launch.py instead of qcar2_manual_drive_launch.py
# so drive commands come from /cmd_vel_nav via nav2_qcar2_converter.
...
def generate_launch_description():
    ...
    qcar2_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([os.path.join(
            get_package_share_directory('qcar2_nodes'), 'launch', 'qcar2_keyboard_drive_launch.py')]
        )
    )

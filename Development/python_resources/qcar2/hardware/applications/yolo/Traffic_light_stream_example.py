...
## -- -- -TRAFFIC LIGHT IP- -- -- 
light_ip = '192.168.2.38'
# -- -- -- -- -- -- -- -- -- -- --

## Initialize the traffic light
print(call_traffic_light(light_ip, "close_stream"))
time.sleep(0.2)
print(call_traffic_light(light_ip, "immediate/off", timeout_s=1))
response = call_traffic_light(light_ip, "start_stream")

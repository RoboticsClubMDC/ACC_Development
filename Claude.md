...
[](https://github.com/RoboticsClubMDC/ACC_Development/blob/Gabriel/CLAUDE.md#claudemd--acc_development_gabriel)

This file gives Claude Code the persistent context it needs when working in this repo. Keep it accurate.

## Project

[](https://github.com/RoboticsClubMDC/ACC_Development/blob/Gabriel/CLAUDE.md#project)
...
[](https://github.com/RoboticsClubMDC/ACC_Development/blob/Gabriel/CLAUDE.md#hardware-qcar2--read-only-context)
...
[](https://github.com/RoboticsClubMDC/ACC_Development/blob/Gabriel/CLAUDE.md#scope-of-work--what-claude-may-and-may-not-touch)
...
[](https://github.com/RoboticsClubMDC/ACC_Development/blob/Gabriel/CLAUDE.md#repo-layout-the-parts-that-matter)
...
[](https://github.com/RoboticsClubMDC/ACC_Development/blob/Gabriel/CLAUDE.md#build--run-cheat-sheet)
...
[](https://github.com/RoboticsClubMDC/ACC_Development/blob/Gabriel/CLAUDE.md#vo-toolbox-knobs-status-as-of-2026-05-19)
...
[](https://github.com/RoboticsClubMDC/ACC_Development/blob/Gabriel/CLAUDE.md#rtab-map--slam-showcase-plan)
...
[](https://github.com/RoboticsClubMDC/ACC_Development/blob/Gabriel/CLAUDE.md#camera-resolution--verdict-revised-2026-05-20)
...
[](https://github.com/RoboticsClubMDC/ACC_Development/blob/Gabriel/CLAUDE.md#ekf-fusion--note-for-when-we-wire-robot_localization)
...
[](https://github.com/RoboticsClubMDC/ACC_Development/blob/Gabriel/CLAUDE.md#camera-intrinsics--which-to-use)
...
[](https://github.com/RoboticsClubMDC/ACC_Development/blob/Gabriel/CLAUDE.md#git-workflow)
...
[](https://github.com/RoboticsClubMDC/ACC_Development/blob/Gabriel/CLAUDE.md#conventions)
...
[](https://github.com/RoboticsClubMDC/ACC_Development/blob/Gabriel/CLAUDE.md#terminals--what-claude-can-and-cant-do)
